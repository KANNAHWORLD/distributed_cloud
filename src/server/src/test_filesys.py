...
class TestFilesys(unittest.TestCase):
    ...
    def test_mkdir(self):
        ...
        self.assertTrue(self.fs.user_loaded_directory.__len__() == 1)
        self.assertTrue(self.fs.pwd() == "~/TestDirec1/TestDirec2")
    ...
    #     # self.fs.rm("TestFile1.txt")
    #     self.fs.rm("TestDirec2")

    #     print(self.fs.user_loaded_directory)
        
    #     self.assertTrue(self.fs.user_loaded_directory.__len__() == 0)
